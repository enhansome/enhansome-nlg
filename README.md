...
* [VizSeq](https://github.com/facebookresearch/vizseq) ⭐ 457 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - A Visual Analysis Toolkit for Text Generation Tasks.
...
* [Tracery](https://github.com/galaxykate/tracery) ⭐ 2,211 | 🐛 32 | 🌐 JavaScript | 📅 2024-11-03 - A story-grammar generation library for JavaScript.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 165,038 | 🐛 2,406 | 🌐 Python | 📅 2026-09-09 - State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
