...
* [Chatito](https://github.com/rodrigopivi/Chatito) ⭐ 890 | 🐛 24 | 🌐 TypeScript | 📅 2023-09-03 - Generate datasets for AI chatbots, NLP tasks, named entity recognition or text classification models using a simple DSL!
...
* [VizSeq](https://github.com/facebookresearch/vizseq) ⭐ 457 | 🐛 6 | 🌐 Python | 📅 2026-09-13 - A Visual Analysis Toolkit for Text Generation Tasks.
...
* [Tracery](https://github.com/galaxykate/tracery) ⭐ 2,213 | 🐛 32 | 🌐 JavaScript | 📅 2024-11-03 - A story-grammar generation library for JavaScript.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 165,904 | 🐛 2,428 | 🌐 Python | 📅 2026-09-14 - State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
...
* [Texar](https://github.com/asyml/texar) ⭐ 2,387 | 🐛 40 | 🌐 Python | 📅 2026-07-21 - Texar is a toolkit aiming to support a broad set of machine learning, especially natural language processing and text generation tasks.
...
* [graph-2-text](https://github.com/diegma/graph-2-text) ⭐ 152 | 🐛 10 | 🌐 Python | 📅 2019-07-12 - Graph to sequence implemented in Pytorch combining Graph convolutional networks and opennmt-py.
...
* [SimpleNLG](https://github.com/simplenlg/simplenlg) ⭐ 832 | 🐛 17 | 🌐 Java | 📅 2024-12-06 - Java API for Natural Language Generation.
* [JSrealB](https://github.com/rali-udem/JSrealB) ⭐ 27 | 🐛 0 | 🌐 HTML | 📅 2026-09-12 - A JavaScript bilingual text realizer for web development.
